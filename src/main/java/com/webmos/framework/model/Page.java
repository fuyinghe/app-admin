...
public class Page {
	...
	private Map<String,String> queryFiled;
	...
	public Map<String, String> getQueryFiled() {
		return queryFiled;
	}

	public void setQueryFiled(Map<String, String> queryFiled) {
	...
	public String toString() {
		return "Page [beginIndex=" + beginIndex + ", endIndex=" + endIndex
				+ ", pageSize=" + pageSize + ", pageNo=" + pageNo
				+ ", totalCount=" + totalCount + ", totalPage=" + totalPage
				+ ", maxPage=" + maxPage + ", beginPage=" + beginPage
				+ ", endPage=" + endPage + ", rows=" + rows + ", tows=" + tows
				+ ", queryFiled=" + queryFiled + "]";
	}
