...
import com.hrbwmxx.framework.util.PropertiesUtil;
	...
	@Controller
	@RequestMapping("NHFileService")
	public class NHFileUploadController {
	public static Logger logger = LoggerFactory.getLogger(NHFileUploadController.class);
	@Autowired
	private NHFileUploadService fileUploadService;
	...
	public void upload(HttpServletResponse response, @RequestParam  MultipartFile upfile,@RequestParam Map<String,String>  map_request ) throws Exception {
		...
		map_request.put("url", "/NHFileService/showImg.do?attachId=");
		map_request.put("downloadUrl", "/NHFileService/download.do?attachId=");
