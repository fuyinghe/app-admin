 ...
 */
package com.hrbwmxx.framework.dao.util;
...
public class BeanProcessor {
     ...
     */
    private static final Set<Class<?>> primitiveWrapper = new HashSet<Class<?>>();

    static {
        primitiveWrapper.add(Integer.class);
        primitiveWrapper.add(Short.class);
        primitiveWrapper.add(Byte.class);
        primitiveWrapper.add(Float.class);
        primitiveWrapper.add(Double.class);
        primitiveWrapper.add(Long.class);
        primitiveWrapper.add(Boolean.class);
        primitiveWrapper.add(Character.class);
        primitiveWrapper.add(String.class);
    }
    ...
    public Object toBean(ResultSet rs, Class type) throws SQLException {
    	...
    	if (type.isPrimitive() || isPrimitiveWrapper(type)) {
    		return processColumn(rs, 1, type);
    	}
    ...
    protected boolean isPrimitiveWrapper(Class type) {
    	return primitiveWrapper.contains(type);
    }
    /**
    ...
    protected Object processColumn(ResultSet rs, int index, Class propType)
    	...
    	if (rs.getObject(index) == null) {
        	...
        	return new BigDecimal(rs.getDouble(index));
