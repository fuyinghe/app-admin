...
public class ParameterMapping {
	...
	private String typeName; // this is used for REF types or user-defined
								// types
	...
	public void setPropertyName(String propertyName) {
		this.errorString = "Check the parameter mapping for the '"
	...
	public void setJavaTypeName(String javaTypeName) {
		try {
			...
			throw new RuntimeException(
					"Error setting javaType property of ParameterMap.  Cause: "
							+ e, e);
		}
	}
	...
	public void setJdbcTypeName(String jdbcTypeName) {
		...
		this.jdbcType = JdbcType.valueOf(jdbcTypeName);
	}
