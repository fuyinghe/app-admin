(function($){
	window.uploadClassForIE = {
	    ...
	    ajaxUpload: function (s, xml) {
	        ...
	        var jForm = $("<form>",{action:s.url,target:idIO,method:"post",enctype:"multipart/form-data",style:"display:none"}).appendTo($("body"))
	    ...
	    ajaxFileUpload: function (s) {
	        ...
	        if (window.ActiveXObject) {
	            var upload = new uploadClassForIE.ajaxUpload(s, xml);
	            upload.start();
	        } else {
	            var id = new Date().getTime();
	            var form = uploadClassForIE.createUploadForm(id, s.url, s.fileElement, (typeof (s.data) == 'undefined' ? false : s.data));
	            var io = uploadClassForIE.createUploadIframe(id, s.secureuri);
	            var frameId = 'jUploadFrame' + id;
	            var formId = 'jUploadForm' + id;
