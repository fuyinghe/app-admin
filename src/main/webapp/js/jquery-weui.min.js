...
$.loading = function(){
	...
	if($("#loadingToast").length == 0){
		$loadingToast = $("<div>",{"id":"loadingToast","style":"display:none;"}).html('<div class="weui-mask_transparent"></div><div class="weui-toast"><i class="weui-loading weui-icon_toast"></i><p class="weui-toast__content">数据加载中</p></div>')
